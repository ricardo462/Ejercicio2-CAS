...
plot(data(:,2),U(1,:),'b+',data(:,2),U(2,:),'r+',data(:,1),U(3,:),'k+')
title('Clusters para  y(k-1)')
xlabel('y(k-1)')
ylabel('Grado de pertenencia')
pause

plot(data(:,3),U(1,:),'b+',data(:,3),U(2,:),'r+',data(:,1),U(3,:),'k+')
title('Clusters para u(k-1)')
xlabel('u(k-1)')
ylabel('Grado de pertenencia')
pause

plot(data(:,4),U(1,:),'b+',data(:,4),U(2,:),'r+',data(:,1),U(3,:),'k+')
...
MU = [med_y1_1, med_u1_1, med_u2_1; ...
      med_y1_2, med_u1_2, med_u2_2; ...
      sqrt(var_y1_1), sqrt(var_u1_1), sqrt(var_u2_1); ...
      sqrt(var_y1_2), sqrt(var_u1_2), sqrt(var_u2_2)];
